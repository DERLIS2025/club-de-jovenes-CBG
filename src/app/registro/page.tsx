          ...
          <div className="flex flex-col gap-4 border-t border-white/10 pt-6">
            ...
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl bg-sky-400 px-8 py-3 font-bold text-slate-950 shadow-[0_12px_28px_rgba(56,189,248,0.28)] transition hover:-translate-y-0.5 hover:bg-sky-300 disabled:cursor-not-allowed disabled:opacity-70"
              >
