...
function CategoryNav() {
  ...
  return (
    <div className="border-b border-[#e5e5e5] bg-white">
      <div className="mx-auto flex max-w-7xl flex-wrap justify-center gap-3 px-4 py-5 sm:gap-4 sm:px-6 lg:px-8">
        {categories.map((cat) => (
          <a
            key={cat.label}
            href={cat.href}
            className="rounded-sm border border-[#e5e5e5] px-6 py-3 text-base font-bold uppercase tracking-wider text-[#666666] transition hover:border-[#1e3a5c] hover:bg-[#1e3a5c] hover:text-white"
          >
            {cat.label}
          </a>
        ))}
